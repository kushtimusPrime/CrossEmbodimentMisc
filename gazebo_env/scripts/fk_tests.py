...
ur5_fk_solver = TracIKSolver("/home/benchturtle/cross_embodiment_ws/src/gazebo_env/description/urdf/ur5_ik_real.urdf","world","wrist_3_link")
...
print(ee_pose)
panda_ur5_ik_solver = TracIKSolver("/home/benchturtle/cross_embodiment_ws/src/gazebo_env/description/urdf/panda_ur5_gripper_ik_real.urdf","world","panda_link8")
